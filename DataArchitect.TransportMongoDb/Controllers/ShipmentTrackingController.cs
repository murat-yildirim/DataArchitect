...
using DataArchitect.TransportMongoDb.Services.ShipmentServices;
using DataArchitect.TransportMongoDb.Services.ShipmentTrackingServices;
...
namespace DataArchitect.TransportMongoDb.Controllers
{
    public class ShipmentTrackingController : Controller
    {
        ...
        {
            var values = await _trackingService.GetAllTrackingAsync(trackingNumber);
